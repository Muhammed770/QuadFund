...
export const IosPickerItem: React.FC<PropType> = (props) => {
    ...
    return (
        <div className={embla.embla__ios_picker}>
            <div className={embla['embla__ios-picker__scene']} ref={rootNodeRef}>
                <div
                    className={`${embla['embla__ios-picker__viewport']} ${embla['embla__ios_picker__viewport--perspective-' + perspective]}`}
                    ref={emblaRef}
                >
                    <div className={embla['embla__ios-picker__container']}>
                        {slides.map((_, index) => (
                            <div className={embla["embla__ios-picker__slide"]} key={index}>
                                {index}
                            </div>
                        ))}
                    </div>
            ...
            <div className={embla["embla__ios-picker__label"]}>{label}</div>
        </div>
    )
}
